...
public class Get12 extends HerOkuAppBaseUrl {
    ...
    public void get12(){
        ...
        BookingPojo expectedData = new BookingPojo("John","Smith",111,true,new BookingDatesPojo(),"Breakfast");
        ...
        //Do Assertion
        BookingPojo actualData = response.as(BookingPojo.class); //karsidan gelen data
