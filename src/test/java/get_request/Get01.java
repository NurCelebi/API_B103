...
public class Get01 {
    ...
    public void get01(){
//        i)Set the URL
        String url = "https://restful-booker.herokuapp.com/booking/55"; //Given bolumu
...
//        iv) Do assertion--then /assertThat ikisi de ayni anlamda kulanilir--datanin digrulugunu kontrol ediyoruz burada
        response.
                then().
