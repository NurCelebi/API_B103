...
//        assertEquals("2019-01-01",jsonPath.getString("bookingdates.checkout"));//actual --expected olaraK BAKIYORUM
//        assertEquals("Extra pillows please",jsonPath.getString("additionalneeds"));
        ...
        //2. Assertion
        softAssert.assertEquals(jsonPath.getString("firstname"),"Josh","firstname uyuşmadı");// actual - expected-message olarakk doldurcaz
