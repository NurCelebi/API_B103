...
public class Post05ObjectMapper_Map extends JsonPlaceHolderBaseUrl {
    ...
    public void post05ObjectMapper() throws IOException {
        ...
        //Do Assertion
        Map<String, Object> actualdData = new ObjectMapper().readValue(response.asString(), HashMap.class); //asString ile cevirmeize ve daha rahat map olsuturmamiza sagliyor.

        System.out.println("actualdData = " + actualdData);

        //
//        Map<String, Object> actualdData = new ObjectMapper().readValue("{\n" +
//                "    \"completed\": false,\n" +
//                "    \"title\": \"Tidy your room\",\n" +
//                "    \"userId\": 55,\n" +
//                "    \"id\": 201\n" +
